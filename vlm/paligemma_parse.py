...
_MODEL_PATH = os.path.join('/home/nawal/data/calcifer','data', 'vae-oid.npz')
...
if __name__ == '__main__':
  ...
  import numpy
  result = '''segment cat in front;\n<loc0082><loc0254><loc0362><loc0636> <seg018><seg011><seg052><seg039><seg042><seg023><seg066><seg090><seg039><seg017><seg079><seg059><seg012><seg074><seg016><seg068> cat in front; <loc0348><loc0240><loc0859><loc0710> <seg012><seg114><seg099><seg087><seg064><seg041><seg035><seg106><seg022><seg106><seg066><seg024><seg058><seg055><seg044><seg060> cat in front'''
  
  img2 = numpy.random.random((412, 622, 3))
  objects = extract_objs(result.split('\n')[1], img2.shape[1], img2.shape[0], unique_labels=False)
